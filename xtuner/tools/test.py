...
def main():
    ...
    llm_name_or_path = '/home/liangyuci/SlideChat_weight/qwen3B/'
    ...
    # # Titan = runner.model.LongNet_encoder.to(model_kwargs['torch_dtype'])
    ...
    # columns = ['ID','Slide','Task','Question','A','B','C','D','Answer','Output']
    # columns = ['question_id','image','metadata','question','T-Answer','Output']
    ...
    for i in range(df_test_case.shape[0]):
        ...
        test_image_file = "/home/liangyuci/features_conch_v15" + "/" + str(case_name) 
        ...
        #         features = h5_file['features'][:]  # numpy array
        #         total_rows = features.shape[0]
        #         sample_num = 38400
        #         if total_rows >= sample_num:
        #             indices = np.linspace(0, total_rows - 1, sample_num, dtype=int)
        #             features = features[indices]
        #         image = torch.from_numpy(features).unsqueeze(0).cuda()  # shape: [1, 38400, 512]
        ...
        titan = TitanVisionTower(
            ...
            #weight_path="/home/liangyuci/SlideChat-titan/work_dirs/stage4-stagel-618new/epoch_1.pth/converted_model_not_pj_llm.safetensors"
            #weight_path="/home/liangyuci/SlideChat-titan/work_dirs/stage4-regional-616new/epoch_1.pth/converted_model_not_pj_llm.safetensors"
        )
        ...
        # image = image.to(runner.model.llm.dtype).cuda()
