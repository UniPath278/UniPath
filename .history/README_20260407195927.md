...
UniPath takes CONCH v1.5 patch features as input. We use [TRIDENT](https://github.com/mahmoodlab/TRIDENT) for WSI preprocessing and feature extraction. To adapt TRIDENT for UniPath:
